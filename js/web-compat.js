...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Uses visualViewport API + transform to keep input bar above iOS keyboard.
        // Does NOT touch html/body positioning - lets iOS handle the viewport naturally.
        (function() {
            ...
            function stickToKeyboard() {
                ...
                // offset = how many px the keyboard is eating from the bottom
                var offset = Math.round(window.innerHeight - vv.height - vv.offsetTop);
                offset = Math.max(0, offset);

                // Only update DOM if value changed (avoids jank)
                if (offset !== lastOffset) {
                    bar.style.transform = offset > 0

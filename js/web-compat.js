...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Resizes the entire layout when the keyboard opens (iOS PWA)
        // Uses --app-height CSS variable to shrink html/body/app
        ...
        if (window.visualViewport) {
            ...
            function handleViewportResize() {
                ...
                var isKeyboardOpen = keyboardHeight > 100;
                
                // Always update the app height to match visual viewport
                ...
                if (isKeyboardOpen) {
                    // Keyboard is open - move input bar above keyboard
                    if (inputBar) inputBar.style.bottom = keyboardHeight + 'px';
                    
                    // Scroll messages to bottom when keyboard just opened
                    ...
                    // Keyboard closed - reset input bar

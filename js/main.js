...
(function () {
    const noBlurIds = ['attachBtn', 'micBtn', 'sendBtn'];
...
function setupEventListeners() {
    ...
    // ===== BOTÃO DE ENVIAR =====
    // Botão simples: sempre mostra seta de enviar, vira stop durante geração
    ...
    if (sendBtn) {
        ...
        sendBtn.addEventListener('click', function (e) {
            ...
            // Se não está em stop-mode, é type=submit, então o form cuida
        });
        
        console.log('✓ Event listener adicionado ao botão sendBtn');
    } else {
        console.error('❌ sendBtn não encontrado!');
    }

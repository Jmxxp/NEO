...
function initFeatures() {
    ...
    // Bloqueio biométrico e por senha desabilitados na versão web
    // initBiometricLock();
    // initPasswordLock();

    // Adicionar ripple effect aos botões principais
    document.querySelectorAll('.send-btn, .new-chat-btn').forEach(btn => {
        addRippleEffect(btn);
    });

    // Toggles de bloqueio removidos na versão web
}
